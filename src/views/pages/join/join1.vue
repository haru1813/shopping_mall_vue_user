                ...
                <div class="card-body">
                    ...
                    <p class="card-text">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="" v-model="allCheck" @change="allCheckf">
...
부 칙(시행일) 이 약관은 년 월 일부터 시행합니다. 부 칙(시행일) 이 약관은 년 월 일부터 시행합니다.
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="" v-model="check1">
...
※ 동의를 거부할 수 있으나 거부시 회원 가입이 불가능합니다.
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="" v-model="check2">
                ...
                <div class="card-footer">
                    <button type="button" class="btn btn-primary" @click="next">다음</button>
                </div>
            </div>
        </div>
    </div>
